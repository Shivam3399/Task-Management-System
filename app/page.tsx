  ...
  return (
    <div className="flex min-h-screen flex-col">
              ...
              <div className="flex flex-col justify-center space-y-4">
                <div className="space-y-2">
                  ...
                  <p className="max-w-[600px] text-gray-500 md:text-xl dark:text-gray-400">
                    TaskMaster helps your team stay organized and efficient. Create, assign, and track tasks with ease.
                  </p>
                </div>
          ...
          <div className="container px-4 md:px-6">
            ...
            <div className="mx-auto grid max-w-5xl grid-cols-1 gap-6 py-12 md:grid-cols-2 lg:grid-cols-3">
              ...
              <div className="flex flex-col items-center space-y-2 rounded-lg border p-6 shadow-sm">
                ...
                <p className="text-sm text-gray-500 text-center dark:text-gray-400">
                  Assign tasks to team members and get notified of updates
                </p>
              </div>
              <div className="flex flex-col items-center space-y-2 rounded-lg border p-6 shadow-sm">
                <div className="p-2 bg-primary/10 rounded-full">
                ...
                <p className="text-sm text-gray-500 text-center dark:text-gray-400">
                  Set due dates and get reminders for upcoming and overdue tasks
                </p>
              </div>
            </div>
          </div>
      ...
      <footer className="flex flex-col gap-2 sm:flex-row py-6 w-full shrink-0 items-center px-4 md:px-6 border-t">
        <p className="text-xs text-gray-500 dark:text-gray-400">© 2023 TaskMaster. All rights reserved.</p>
