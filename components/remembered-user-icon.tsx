...
import { type RememberedUser, getUserInitials } from "@/utils/auth-db"

interface RememberedUserIconProps {
  user: RememberedUser
...
export function RememberedUserIcon({ user, onLogin, onForget, disabled = false }: RememberedUserIconProps) {
